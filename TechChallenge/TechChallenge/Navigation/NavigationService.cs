...
namespace TechChallenge.Navigation
{
    public class NavigationService : INavigationService
    {
        ...
        {
            NavigateTo(pageKey, parameter, null, null, null, null, null, false, false);
        }
        ...
        {
            NavigateTo(pageKey, parameter1, parameter2, parameter3, parameter4, parameter5, parameter6, false, false);
        }

        private void NavigateTo(string pageKey, object parameter1, object parameter2, object parameter3,
                                object parameter4, object parameter5, object parameter6, bool replaceRoot, bool isModal)
        {
            lock (_pagesByKey)
            {
        ...
        {
            NavigateTo(pageKey, null, null, null, null, null, null, replaceRoot: true, isModal: false);
        }
